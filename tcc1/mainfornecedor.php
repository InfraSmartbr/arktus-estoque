...
<a class="navbar-brand" href="mainfornecedor.php">HyperSports</a>
...
<br><br>
<br><br>
<?php $result_fornecedor = "SELECT * FROM fornecedor WHERE cnpj = '".$_SESSION['cnpj']."'";
$resultado_fornecedor = mysqli_query($conn, $result_fornecedor);
$row_fornecedor = mysqli_fetch_assoc($resultado_fornecedor);
?>
<div class="card mb-3">
     <div class="card-header">
         <h5 class="display-5" style="font-size:26px;text-align:center;font-style: italic;color:white;"> SEJA BEM VINDO! <br><?php echo $row_fornecedor['nome']; ?></h5>
     </div><!-- fim .card-header -->
    </div>
