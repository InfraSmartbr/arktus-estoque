    ...
    <li class="nav-item">
     ...
     <!-- <li class="nav-item dropdown">
      ...
      <img src="./imagens/icons/listar.png"align="center">
        ...
        <a class="dropdown-item" href="php/listar.php"><img src="./imagens/icons/listar.png"align="center"> Listar Pessoal </a>
        <a class="dropdown-item" href="php/listar_fornecedor.php"><img src="./imagens/icons/listar.png"align="center"> Listar Fornecedor</a>
...
<?php }?>
<?php
    if(isset($_SESSION['msglistarfornecedor'])){
?><?=$_SESSION['msglistarfornecedor']?>
<?php }?>
<div class="card mb-3">
     <div class="card-header">
         <h5 class="display-5" style="font-size:26px;text-align:center;font-style: italic;color:white;"> SEJA BEM VINDO! </h5>
     </div><!-- fim .card-header -->
    </div>
