...
// ---------------------------------------------------------
while($row_usuario = mysqli_fetch_assoc($resultado_compra)) {
  echo "<table align=center border=1 bordercolor=white>".
  "<tr>"."<td colspan='3' style='background-color:black;'>"."<h4 style='color:#fff;'>"."Compra:"."</h1>"."</td>"."</tr>";
    echo "<tr>". 
    "<td>"."Código da Compra:"."</td>".
   "<td >".$row_usuario['codigo_compra'] . "</td>"."</tr>";
    echo "<tr>".
    "<td> " ."CPF CLIENTE:"."</td>".
    "<td >".$row_usuario['cliente_cpf'] ."</td>"."</tr>";
        echo "<tr>"."<td > "."Chassi do Carro: " ."</td>"."<td >".$row_usuario['carros_chassi'] ."</td>"."</tr>";
        echo "<tr>"."<td > "."Código de Pagamento: " ."</td>"."<td >".$row_usuario['cod_pagamento'] ."</td>"."</tr>";
        echo "<tr>"."<td >"."Nome do Titular Cartão: " ."</td>"."<td >".$row_usuario['nome_titular_cartao'] ."</td>"."</tr>";
        echo "<tr>"."<td >"."ENTREGA: " ."</td>"."<td >".$row_usuario['identrega'] ."</td>"."</tr>";
