...
<a class="navbar-brand" href="../index.php">HyperSports</a>
  ...
  <div class="collapse navbar-collapse" id="navbarTogglerDemo02">
    ...
    <li class="nav-item">
      ...
      <li class="nav-item">
      <a class="nav-link" href="listar_fornecedor.php"><img src="../imagens/icons/listar.png"align="center">&nbsp;&nbsp;&nbsp;&nbsp; Listar <span class="sr-only">(current)</span></a>
      </li>
      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
      <li class="nav-item">
...
<!-- Fim da Nav -->
<li id='listar'><a href='../fornecedor.php'><img src='../imagens/icons/voltar.png' align-text="bottom"> Voltar para o Cadastro</a></li>
...
$result_usuarios= "select * from fornecedor where cnpj = '".$_SESSION['cnpj']."'";  
...
while($row_usuario = mysqli_fetch_assoc($resultado_usuarios)) {
  ...
  "<tr>"."<td colspan='3' style='background-color:black;'>"."<h4 style='color:#fff;'>"."Usúario:"."</h1>"."</td>"."</tr>";
    echo "<tr>". 
    "<td>"."CNPJ:"."</td>".
   "<td >".$row_usuario['cnpj'] . "</td>"."</tr>";
    echo "<tr>".
    "<td> " ."NOME:"."</td>".
    "<td >".$row_usuario['nome'] ."</td>"."</tr>";
        echo "<tr>"."<td > "."CARROS CHASSI: " ."</td>"."<td >".$row_usuario['carros_chassi'] ."</td>"."</tr>";
        echo "<tr>"."<td > "."MARCA: " ."</td>"."<td >".$row_usuario['idmarca'] ."</td>"."</tr>";
        echo "<tr>"."<td >"."RUA: " ."</td>"."<td >".$row_usuario['rua'] ."</td>"."</tr>";
        echo "<tr>"."<td >"."CIDADE: "."</td>"."<td > ".$row_usuario['cidade'] ."</td>"."</tr>";
        echo "<tr>"."<td >"."ESTADO: "."</td>"."<td >".$row_usuario['uf'] ."</td>"."</tr>";
        ...
        echo "<tr>".
        "<td id='l'>".
        "<a href='edit_fornecedor.php?cnpj=".$row_usuario['cnpj'] . "'>"."<img src='../imagens/icons/editar.png' text-align=center/>    Editar    </a>".
        "</td>".
        "<td id='r'>".
        "<a  href='excluir_fornecedor.php?cnpj=".$row_usuario['cnpj'] . "'><img src='../imagens/icons/excluir.png' align=center/> Excluir </a>".
        "</td>".
        "</tr>";
        echo "</table>";
        echo "<hr>";
