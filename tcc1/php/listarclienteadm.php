  ...
  <div class="collapse navbar-collapse" id="navbarTogglerDemo02">
    ...
    <li class="nav-item">
      ...
      <img src="../imagens/icons/listar.png"align="center">
        ...
        <div class="dropdown-menu " aria-labelledby="navbarDropdownMenuLink">
        <a class="dropdown-item" href="listar_carros.php"><img src="../imagens/icons/listar.png"align="center">Listar Carros </a>
        <a class="dropdown-item" href="listarclienteadm.php"><img src="../imagens/icons/listar.png"align="center"> Listar dos clientes </a>
        <a class="dropdown-item" href="listarfornecedoradm.php"><img src="../imagens/icons/listar.png"align="center"> Listar Fornecedor</a>
         <a class="dropdown-item" href="listaradm.php"><img src="../imagens/icons/listar.png"align="center"> Listar ADM</a>
        </div>
      </li>
      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
      <li class="nav-item">
...
<!-- Fim da Nav -->
<li id='listar'><a href='../form.php'><img src='../imagens/icons/voltar.png' align-text="bottom"> Voltar para o Cadastro</a></li>
...
while($row_usuario = mysqli_fetch_assoc($resultado_usuarios)) {
  ...
  "<tr>"."<td colspan='3' style='background-color:black;'>"."<h4 style='color:#fff;'>"."Usúario:"."</h1>"."</td>"."</tr>";
    echo "<tr>". 
    "<td>"."CPF:"."</td>".
   "<td >".$row_usuario['cpf'] . "</td>"."</tr>";
    ...
    "<td >".$row_usuario['rg'] ."</td>"."</tr>";
        ...
        echo "<tr>".
        "<td id='l'>".
        "<a href='edit_usuario.php?cpf=".$row_usuario['cpf'] . "'>"."<img src='../imagens/icons/editar.png' text-align=center/>    Editar    </a>".
        "</td>".
        "<td id='r'>".
        "<a  href='proc_apagar_usuario.php?cpf=".$row_usuario['cpf'] . "'><img src='../imagens/icons/excluir.png' align=center/> Excluir </a>".
        "</td>".
        "</tr>";
        echo "</table>";
        echo "<hr>";
