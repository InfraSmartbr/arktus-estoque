...
<a class="navbar-brand" href="indexx.php">HyperSports</a>
  ...
  <div class="collapse navbar-collapse" id="navbarTogglerDemo02">
    ...
    <li class="nav-item">
      ...
      <img src="./imagens/icons/cadastro.png"align="center">
       ...
       <a class="dropdown-item" href="formadm.php"><img src="./imagens/icons/pessoal.png"align="center"> Cadastro Administrador</a>
        </div>
      </li>
     <li class="nav-item dropdown">
      <a class="nav-link dropdown-toggle" href="#" id="navbarDropdownMenuLink" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="true">
      <img src="./imagens/icons/listar.png"align="center">
        ...
        <div class="dropdown-menu " aria-labelledby="navbarDropdownMenuLink">
        <a class="dropdown-item" href="php/listar_carros.php"><img src="./imagens/icons/listar.png"align="center">Listar Carros </a>
        <a class="dropdown-item" href="php/listarclienteadm.php"><img src="./imagens/icons/listar.png"align="center"> Listar dos clientes </a>
        <a class="dropdown-item" href="php/listarfornecedoradm.php"><img src="./imagens/icons/listar.png"align="center"> Listar Fornecedor</a>
        <a class="dropdown-item" href="php/listaradm.php"><img src="./imagens/icons/listar.png"align="center"> Listar ADM</a>
        </div>
      </li>
      <li class="nav-item">
      <a class="nav-link" href="php/listar_compra.php"><img src="./imagens/icons/listar.png" align="center"> Compras <span class="sr-only">(current)</span></a>
      </li>
      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
      <li class="nav-item">
...
?><?=$_SESSION['msgcompra']?>
<?php }?>
<?php $result_funcionario = "SELECT * FROM funcionario WHERE cpf = '".$_SESSION['cpf']."'";
$resultado_funcionario = mysqli_query($conn, $result_funcionario);
$row_funcionario = mysqli_fetch_assoc($resultado_funcionario);
?>
<div class="card mb-3">
     <div class="card-header">
         <h5 class="display-5" style="font-size:26px;text-align:center;font-style: italic;color:white;"> SEJA BEM VINDO! <br><?php echo $row_funcionario['nome']; ?></h5>
     </div><!-- fim .card-header -->
    </div>
